        ...
        for id in ids:
            ...
            if stock_pick_ids:
                move_ids += move_obj.search(cr, uid,
                                            [('picking_id', 'in', stock_pick_ids)])
        move_ids = list(set(move_ids))
        return move_ids

    _columns = {
        'cc_pre_auth': fields.related('sale_id', 'cc_pre_auth',
                                      string='CC Pre-authorised', type='boolean'),
        ...
        ], "Invoice Control", select=True, required=True, readonly=True,
