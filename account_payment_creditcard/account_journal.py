...
class res_partner(osv.osv):
    ...
    def write(self, cr, uid, ids, vals, context=None):
        if vals.get('bank_ids', []) and len(vals['bank_ids'][0]) == 3 and \
                vals['bank_ids'][0][2]:
...
class res_partner_bank(osv.osv):
    ...
    # Given size 256 because the credit card is stored as encrypted format.
    ...
    def copy(self, cr, uid, id, default=None, context=None):
        ...
        default.update(vals)
        return super(res_partner_bank, self).copy(cr, uid, id, default=default,
                                                  context=context)
